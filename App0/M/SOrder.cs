...
namespace App0.M
{
    ...
    struct SOrder
    {
        ...
        /// Тип стаканчика
        /// </summary>
        public TypeOfGlass Glass { get; private set; }
        ...
        /// <summary>
        /// Установка стаканчика
        /// </summary>
        /// <param name="glass">тип стаканчика</param>
        public void SetGlass(TypeOfGlass glass)
        {
